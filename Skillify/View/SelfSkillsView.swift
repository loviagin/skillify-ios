...
struct SelfSkillsView: View {
    ...
    init(authViewModel: AuthViewModel) {
        _viewModel = StateObject(wrappedValue: SkillsViewModel(authViewModel: authViewModel))
    }
        ...
        VStack{
            VStack(alignment: .leading){
                Image("logo")
                    ...
                    .scaledToFit()
                    .frame(width: 100)
                Text("Choose up to 5 skills you know")
            }
...
struct SelfSkillsView_Previews: PreviewProvider {
