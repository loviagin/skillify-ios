...
//    }
    ...
    func sendNotification(header: String = "Learnsy", playerId: String, messageText: String, targetText: String = "", type: NotificationType = .system, privacy: [String]? = nil, completion: () -> Void = {}) async {
